...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=False,
        required=False,
        help="Should we utilize it in inpainting mode"
    )
    parser.add_argument(
        "--dataset_config_name",
        type=str,
    ...
    parser.add_argument(
        "--cross_or_self", type=int, default=None,
    )
    parser.add_argument(
        "--allow_tf32",
        action="store_true",
